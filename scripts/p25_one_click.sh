cd "/home/shy/AIR/小长/GMTI程序/GMTI/GMTI_algorithm/GMTI_APX15_CUDA_latest" || exit 1

cat > run_motion_comp_stage2_matrix.sh <<'BASH'
#!/usr/bin/env bash
set -euo pipefail
...
chmod +x run_motion_comp_stage2_matrix.sh
./run_motion_comp_stage2_matrix.sh
