...
- 输出目录：`outputs/stage2`
- 回波数据：`outputs/stage2/data/stage2_statistical_newprotocol.bin`，大小 1.40 GiB
- 仿真 PRT 数：7930
...
- `outputs/stage2/config/stage2_config.json`：存在
- `outputs/stage2/config/temp_config_stage2_newsystem.xml`：存在
- `outputs/stage2/data/stage2_statistical_newprotocol.bin`：存在
- `outputs/stage2/truth/scene_truth.csv`：存在
- `outputs/stage2/truth/target_truth_pulse.csv`：存在
- `outputs/stage2/truth/target_truth_beam_summary.csv`：存在
- `outputs/stage2/reports/stage2_simulation_report.md`：存在
- `outputs/stage2/logs/simulate_stage2.log`：存在
- `outputs/stage2/logs/algorithm_run.log`：未生成
