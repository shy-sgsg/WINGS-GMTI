...
- input_data_dir: `none`
- output_dir: `outputs/target_only_visibility`
- output_data_file: `outputs/target_only_visibility/data/stage1_background_with_target.bin`
...
- amplitude_mode: direct_amplitude
- target_snr_db: 30
- direct_amplitude: 1
- chirp_phase_sign: 1
